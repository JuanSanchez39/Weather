var key = '9e3433936b6e90baa334345a1d72419a';
var city = "Miami"
...
//generates buttons based on search paramenters
...
//applies data and launches the 5 day weather
function getWeatherToday() {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            // //UV index will match according to temp data
            // if (uvi >= 0 && uvi <= 2) {
...
function getFiveDayForecast() {
    ...
    $.ajax({
        ...
        var myWeather = [];
        //allows the data to flow easier
        ...
        //pushed the info cards onto page 
